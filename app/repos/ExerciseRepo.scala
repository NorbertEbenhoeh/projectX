...
class ExerciseRepoImpl @Inject() (reactiveMongoApi: ReactiveMongoApi) extends ExerciseRepo {

  protected def collection: JSONCollection = reactiveMongoApi.db.collection[JSONCollection]("exercises")
